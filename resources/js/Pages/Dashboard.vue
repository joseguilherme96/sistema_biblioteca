...
watchEffect(() => {
    ...
    if (props.flash.error) {
        mensagem.value = { status: 'warning', message: props.flash.error, exibir: true, title: 'Permissão' }
    }
...
<template>
    ...
    <Head title="Home" />
    <AuthenticatedLayout :auth="auth" @permissoes="(value) => setPermissoes(value)" v-show="false">
    </AuthenticatedLayout>
    ...
    <div class="container text-end" style="color: white;">
                ...
                <Dropdown>
                    ...
                    <template #content>
                        <div>
                            ...
                            <DropdownLink :href="route('logout')" method="post" as="button" style="color: 310740;">
                                Sair
                            </DropdownLink>
                        </div>
                    </template>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4 d-flex flex-column align-items-center p-5"
                ...
                <OpcaoSistema :data="opcao" :style="!opcao.permissao ? 'opacity: 30%;' : ''">
                </OpcaoSistema>
            </div>
        </div>
    </div>
...
watch(() => permissoes.value, () => {
    ...
    opcoesSistema.value = [{
        ...
        permissao: permissoes.value.livros.cadastro
    },
    {
        name: 'Consulta livro',
        icone: 'bi bi-search',
        ...
        exibir: true,
        route: 'lista_livro',
        permissao: permissoes.value.livros.lista
    },
    {
        ...
        exibir: true,
        route: 'register',
        permissao: permissoes.value.usuarios.cadastro
    },
    {
    ...
    },
    {
        ...
        permissao: permissoes.value.estoque.movimentacao_estoque
    },
    {
        name: 'Editar informações do perfil',
        icone: 'bi bi-people',
        d: 'M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4',
        exibir: true,
        route: 'profile.edit',
        permissao: permissoes.value.usuarios.editar
    },
    {
        ...
        permissao: permissoes.value.reserva.lista_reservas
    },
    {
        ...
        permissao: permissoes.value.estoque.entrada
    },
    {
        name: 'Cadastro Livro',
        icone: 'bi bi-people',
